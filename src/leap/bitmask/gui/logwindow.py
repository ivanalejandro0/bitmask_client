...
class QtLogHandler(logbook.Handler,  logbook.StringFormatterHandlerMixin):
    ...
    def emit(self, record):
        """
        Emit the specified logging record uning a Qt Signal.
        ...
        if record.msg == "Starting authentication process...":
            print "AUTH"
...
class LoggerWindow(QtGui.QDialog):
    ...
    def _connect_to_handler(self):
        """
        Connect this window with the handler through a signal that communicates
        the logger events.
        """
